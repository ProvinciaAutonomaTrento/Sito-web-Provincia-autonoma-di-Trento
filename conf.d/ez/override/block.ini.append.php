...
ViewList[]=lista_paginata_card_image
ViewList[]=lista_paginata_banner
ViewList[]=lista_paginata_banner_color
ViewName[]
ViewName[lista_paginata]=Card (teaser)
ViewName[lista_paginata_card]=Card
ViewName[lista_paginata_card_image]=Card (solo immagine)
ViewName[lista_paginata_banner]=Banner
ViewName[lista_paginata_banner_color]=Banner (colorati)
TTL=3600
ItemsPerRow[]
ContainerStyle[]
ContainerStyle[lista_paginata]=section py-5
ContainerStyle[lista_paginata_card]=py-5
ContainerStyle[lista_paginata_card_image]=section py-5
ContainerStyle[lista_paginata_banner]=py-5
ContainerStyle[lista_paginata_banner_color]=py-5
CanAddShowAllLink=enabled
CanAddIntroText=enabled
