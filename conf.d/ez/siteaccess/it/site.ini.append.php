...
[SearchSettings]
DelayedIndexing=classbased
DelayedIndexingClassList[]=article
DelayedIndexingClassList[]=banner
DelayedIndexingClassList[]=channel
DelayedIndexingClassList[]=dataset
DelayedIndexingClassList[]=document
DelayedIndexingClassList[]=event
DelayedIndexingClassList[]=faq_group
DelayedIndexingClassList[]=faq_root
DelayedIndexingClassList[]=folder
DelayedIndexingClassList[]=frontpage
DelayedIndexingClassList[]=image
DelayedIndexingClassList[]=insight
DelayedIndexingClassList[]=organization
DelayedIndexingClassList[]=pagina_sito
DelayedIndexingClassList[]=place
DelayedIndexingClassList[]=public_person
DelayedIndexingClassList[]=public_private_organization
DelayedIndexingClassList[]=public_project
DelayedIndexingClassList[]=public_service
DelayedIndexingClassList[]=selection_process
DelayedIndexingClassList[]=topic
...
X-Instance[/]=cidpat
Cache-Control[/api/opendata/v2]=no-cache, must-revalidate
...
SiteURL=opencity-pat.localtest.me
LoginPage=embedded
